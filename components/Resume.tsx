...
const resumeContent: Content = {
  ...
  education_list: [
    {
      course: "Zhytomyr Polytechnic State University (Software Engineering)",
      institution: "University Ukraine",
      period: "Oct 2020 - Feb 2024",
      result: "3.89",
      image: "/Zhytomyr Polytechnic State University Mark.png",
    },
  ],
  experience_list: [
    {
      ...
      description: [
        "Since got a job at company, the role is frontend and backend developer, and currently maintaining the server that is under heavy load by many users to ensure that it operates normally",
        "I am also in charge of carrying out large an d small projects that are proposed. I have developed 70% of the server, and I am currently in charge of and responsible for the periodic updates of the frontend."
      ],
  ...
  social_list: [
    ...
    {
      name: "github.com/SimonAlvas",
      link: "https://www.github.com/SimonAlvas",
      icon: <GitHubLogoIcon className="w-5 h-5" />,
    },
    {
      name: "simonalvas2@gmail.com",
      link: "mailto:simonalvas2@gmail.com",
      icon: <EnvelopeClosedIcon className="w-5 h-5" />,
    },
    {
      name: "simonalvas.com",
      link: "https://www.simonalvas.net",
